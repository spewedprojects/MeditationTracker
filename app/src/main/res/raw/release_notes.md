...
101. [14.0.2 (11/03/2026)](https://github.com/spewedprojects/MeditationTracker/releases/tag/v14.0.2)
...
99. **[14.0.0 (04/03/2026)](https://github.com/spewedprojects/MeditationTracker/releases/tag/v14.0.0)**
...
91. [13.1.2 (12/02/2026)](https://github.com/spewedprojects/MeditationTracker/releases/tag/v13.1.3)
> - Fixed crash related to letterspacing retrieval - dimens does not accept raw values.
...
>  - Goal cards now show target per day, instead of just the entire target. Made some Changes to how date range was being displayed and refactored the corresponding files. 
